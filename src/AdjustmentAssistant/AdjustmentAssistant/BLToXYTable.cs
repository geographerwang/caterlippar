...
namespace AdjustmentAssistant
{
    class BLToXYTable
    {
        internal void DrawTable(Panel pnlResult, int dataCount, ref TableLayoutPanel tableLayoutPanel)
        {
            ...
            tableLayoutPanel.Controls.Add(lblBL, 1, 0);
            ...
            tableLayoutPanel.Controls.Add(lblXY, 3, 0);
            ...
            tableLayoutPanel.Controls.Add(lblX, 3, 1);
            Label lblY = new Label();
            lblY.Margin = new Padding(0);
            lblY.Width = 99;
            lblY.Text = "Y";
            lblY.TextAlign = ContentAlignment.MiddleCenter;
            tableLayoutPanel.Controls.Add(lblY, 4, 1);
